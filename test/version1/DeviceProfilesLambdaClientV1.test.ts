...
import { DeviceProfilesLambdaClientV1 } from '../../src/version1/DeviceProfilesLambdaClientV1';

suite('DeviceProfilesLambdaClient', ()=> {
    ...
    let client: DeviceProfilesLambdaClientV1;
    let fixture: DeviceProfilesClientFixtureV1;

    setup((done) => {
        client = new DeviceProfilesLambdaClientV1();
